...
public class TopHitsFragment extends Fragment implements OnItemClicked {
    ...
    private void buildTopChartsData() {
        topChartsModelList.add(new TopChartsModel(R.drawable.alone, "On My Way", "200M+ Plays"));
        topChartsModelList.add(new TopChartsModel(R.drawable.backtou, "Back To U", "155M+ Plays"));
        topChartsModelList.add(new TopChartsModel(R.drawable.girlslikeu, "Girls Like U", "500M+ Plays"));
        topChartsModelList.add(new TopChartsModel(R.drawable.darkside, "Dark Side", "100M+ Plays"));
        topChartsModelList.add(new TopChartsModel(R.drawable.happier, "Happier", "150M+ Plays"));
        topChartsModelList.add(new TopChartsModel(R.drawable.me, "Me", "200M+ Plays"));
        topChartsModelList.add(new TopChartsModel(R.drawable.intent, "Intent", "2M Plays"));
        topChartsModelList.add(new TopChartsModel(R.drawable.shameless, "ShameLess", "230M+ Plays"));
        topChartsModelList.add(new TopChartsModel(R.drawable.sucker, "Sucker", "100M+ Plays"));
        topChartsModelList.add(new TopChartsModel(R.drawable.sunflower, "Sunflower", "500M+ Plays"));
        topChartsModelList.add(new TopChartsModel(R.drawable.withoutme, "Without Me", "250M+ Plays"));
        topChartsModelList.add(new TopChartsModel(R.drawable.hope, "Hope", "200M+ Plays"));
        topChartsModelList.add(new TopChartsModel(R.drawable.movetomiami, "Move To Miami", "50k Followers"));
