...
public class SearchSongActivity extends AppCompatActivity  implements OnClickListener, ItemClickListeners {
        ...
        SearchVoice.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Toast.makeText(SearchSongActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                }
